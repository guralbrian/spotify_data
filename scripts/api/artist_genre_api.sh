...
#SBATCH --output=$log_dir/spotify_analysis_%j.out
#SBATCH --error=$log_dir/spotify_analysis_%j.err
...
Rscript scripts/api/artist_genre_api.R $start_index $end_index $client_id $client_secret
