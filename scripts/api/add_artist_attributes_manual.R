...
ind <- "rsharp" #args[1]
client_id <-   "c754a384dab5409faec10df188bbe142" #args[2]
client_secret <- "d69521cc39664c59a85ed16f18aeae41" #args[3]
attribute.csv <- "art_ft_1_500.csv" #args[4]
...
test <- get_artist_audio_features("WALK THE MOON")

# Fetch data
art.ft <- lapply(artists.needed[1:3], function(x) {
  return(tryCatch(
    .getArtistDf(x) ,
