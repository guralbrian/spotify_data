...
png_path_1 <- paste0("/home/rstudio/results/individuals/", id, "/artists.png")
if(file.exists(png_path_1) == F) {
  png(png_path_1, width = 14, height = 8, units = "in", res = 300)}
w.artist + plot_annotation(title = paste0(name, "'s Top Artists of the past year"),
...
png_path_2 <- paste0("/home/rstudio/results/individuals/", id, "/tracks_daily.png")
