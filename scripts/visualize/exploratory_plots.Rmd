...
pdf_path_1 <- "~/results/readme/images/brian_tartists_09242023.pdf"
...
pdf_path_2 <- "~/results/readme/images/brian_summary_09242023.pdf"
if(file.exists(pdf_path_2) == F) {
pdf(pdf_path_2)}


w.person + plot_annotation(title = "Brian's favorite music and listening times",
                           theme = theme(plot.title = element_text(size = 25)))
