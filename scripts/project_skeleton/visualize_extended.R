...
png_path_1 <- "/home/rstudio/results/skeleton/artists.png"
if(file.exists(png_path_1) == F) {
png(png_path_1, width = 14, height = 8, units = "in", res = 300)}
w.artist + plot_annotation(title = paste0(name, "'s Top Artists since 2020"),
...
png_path_2 <- "/home/rstudio/results/skeleton/tracks_daily.png"
